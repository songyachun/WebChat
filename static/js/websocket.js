...
//    var name= '{{username}}';
    ...
    if('WebSocket' in window){
        //处理收发消息
        msgsocket = new WebSocket("ws://176.140.10.2:8000/chat/friend_id");
        //处理接收好友列表
        listsocket = new WebSocket("ws://176.140.10.2:8000/chat/friend_list");
        console.log("支持websocket")
    }else if('MozWebSocket' in window){
        msgsocket = new MozWebSocket("ws://176.140.10.2:8000/chat/friend_id");
        listsocket = new MozWebSocket("ws://176.140.10.2:8000/chat/friend_list");
    }else{
        msgsocket = new SockJS("ws://176.140.10.2:8000/chat/friend_id");
        listsocket = new SockJS("ws://176.140.10.2:8000/chat/friend_list");
    }
    // 打开连接时
