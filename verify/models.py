...
class UserInfo(models.Model):
    ...
    birthday=models.CharField("生日",max_length=100,null=True,default='')
    profile_head = models.ImageField("头像", blank=True, null=True, upload_to="avatar/",default='')
    profile=models.CharField("个性签名",max_length=255,null=True,default='')
    user=models.OneToOneField(User)
    # 外键：关联省份表
    province_id = models.ForeignKey(Province, related_name="省份ID", null=True,blank=True)
    # 外键；关联城市表
    city_id = models.ForeignKey(City, related_name="省份ID",null=True,blank=True)
